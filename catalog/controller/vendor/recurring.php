...
class ControllervendorRecurring extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('vendor/recurring', '', true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/recurring', '', true)
		);

		$data['add'] = $this->url->link('vendor/recurring/add', '', true);
		$data['copy'] = $this->url->link('vendor/recurring/copy', '', true);
		$data['delete'] = $this->url->link('vendor/recurring/delete', '', true);
		...
		foreach ($results as $result) {
			$data['recurrings'][] = array(
				...
				'edit'         => $this->url->link('vendor/recurring/edit','recurring_id=' . $result['recurring_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('vendor/recurring','sort=pd.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('vendor/recurring','sort=p.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/recurring',$url . 'page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['recurring_id'])) {
			$data['action'] = $this->url->link('vendor/recurring/add', '', true);
		} else {
			$data['action'] = $this->url->link('vendor/recurring/edit','recurring_id=' . $this->request->get['recurring_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/recurring', '', true);
