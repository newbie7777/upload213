...
class ControllerVendorOption extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('vendor/option', '', true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/option', '', true)
		);

		$data['add'] = $this->url->link('vendor/option/add', '', true);
		$data['delete'] = $this->url->link('vendor/option/delete', '', true);
		...
		foreach ($results as $result) {
			$data['options'][] = array(
				...
				'edit'       => $this->url->link('vendor/option/edit','option_id=' . $result['option_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('vendor/option','sort=od.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('vendor/option','sort=o.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/option', $url . 'page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['option_id'])) {
			$data['action'] = $this->url->link('vendor/option/add', '', true);
		} else {
			$data['action'] = $this->url->link('vendor/option/edit','option_id=' . $this->request->get['option_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/option', '', true);
