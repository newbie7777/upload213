...
class ModelVendorRecurring extends Model {
	public function addRecurring($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_recurring SET recurring_id = '" . (int)$recurring_id . "', vendor_id = '" . (int)$this->vendor->getId() . "'");
	...
	public function getRecurrings($data = array()) {
		...
		if(isset($data['vendor_id'])){
			$sql .= " and v2r.vendor_id='".(int)$data['vendor_id']."'";
		}
